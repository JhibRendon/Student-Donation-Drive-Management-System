...
import { 
  ...
  Activity, Filter, Calendar, Archive, Download, Search
} from "lucide-react";
...
const ActivityLogs = () => {
  ...
  const exportPDF = () => {
    try {
      ...
      // Header
      doc.setFontSize(18);
      doc.setTextColor(55, 48, 163); // indigo-950
      ...
      {/* MAIN CONTENT */}
       <main className="flex-1 p-6 ml-60 ">
        ...
        <header className="flex justify-between items-start border-b-2 border-indigo-950 pb-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold text-indigo-950 mb-1">Activity Logs</h1>
            <p className="text-gray-600 font-medium">
              Monitor all system activities and actions <span className="text-indigo-950 font-semibold">({logs.length} total)</span>
            </p>
          </div>
          <button
            onClick={exportPDF}
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 mb-8">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h3 className="font-bold text-lg text-indigo-950">Filter Activities</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition bg-white font-medium"
              >
          ...
          <div>
            <div className="space-y-4 mb-8">
              ...
              {paginatedLogs.map((log, index) => {
                ...
                const userTextColor = log.userType === "admin" ? "text-purple-700" : "text-blue-700";

                return (
                  <div key={log._id}
                    className="bg-white rounded-xl shadow-md border border-gray-200 p-5 hover:shadow-lg hover:border-indigo-300 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {/* RIGHT SECTION - Timestamp & Details */}
